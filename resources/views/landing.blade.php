...
<style>
    .banner {
        height: 100vh;
        width: 100vw;
        background-image: url("{{ asset('/assets/images/GedungMAIFinal.jpg') }}");
    ...
    @media (max-width: 768px) {
        .banner {
            /* height: 500px; */
            background-image: url("{{ asset('/assets/images/GedungMAIFinalMobilesFix.jpg') }}");
        }
    }
</style>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <picture>
                    ...
                    <!-- default (desktop) -->
                    <div class="banner">
                        <!-- <img src="" alt="{{ asset('/assets/images/gedung_only.png') }}"> -->
                    </div>
                </picture>
